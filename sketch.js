...
function preload(){
  bgimg= loadImage("bg.jpg");
    happy_img = loadImage("happy.png");
    cry_img = loadImage("cry2.png");
       angry_img = loadImage("angry.png");
       excited_img = loadImage("excited.png");
       player_img=loadImage("hunter.png");
       gameOver_img=loadImage("gameOver.png")
       Restart_img=loadImage("restart.png")
      Sound_happy=loadSound("Sound_happy.wav");
     Sound_sad=loadSound("Sound_sad.wav");
